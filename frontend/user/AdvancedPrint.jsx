...
const AdvancedPrint = ({ onNavigate, onOpenAuth }) => {
    ...
    const [services, setServices] = useState([
        ...
        },
        {
            ...
            sizes: ['24×36 inch', '36×48 inch', 'Custom'],
            finishes: ['Matte', 'Glossy', 'Canvas'],
        },
        {
            id: 'a3',
            name: 'A3 Print',
            description: 'Larger than standard prints for detailed documents',
            iconName: 'Layers',
            price: '₹25/page',
            popular: false,
            image: 'https://images.unsplash.com/photo-1513542789411-b6a5d4f31634?w=400',
            sizes: ['A3'],
            finishes: ['Standard', 'Premium', 'Photo'],
        },
        {
            id: 'poster',
            name: 'Poster Print',
            ...
            sizes: ['A2', 'A1', 'A0', 'Custom'],
            finishes: ['Matte', 'Glossy', 'Semi-Gloss'],
        },
        {
            id: 'businessCard',
            name: 'Business Cards',
            ...
            sizes: ['Standard (3.5×2 inch)', 'Square'],
            finishes: ['Matte', 'Glossy', 'Spot UV', 'Embossed'],
        },
        {
            id: 'brochure',
            name: 'Brochures',
            description: 'Marketing brochures in various folds and sizes',
            iconName: 'BookOpen',
            price: '₹15/piece',
            popular: false,
            image: 'https://images.unsplash.com/photo-1532153955177-f59af40d6472?w=400',
            sizes: ['Bi-fold', 'Tri-fold', 'Z-fold'],
            finishes: ['Matte', 'Glossy'],
        },
        {
            id: 'banner',
            name: 'Banners',
            description: 'Indoor and outdoor banners for events and promotions',
            iconName: 'Flag',
            price: '₹200+',
            popular: false,
            image: 'https://images.unsplash.com/photo-1569428034239-f9565e32e224?w=400',
            sizes: ['2×4 ft', '3×6 ft', '4×8 ft', 'Custom'],
            finishes: ['Vinyl', 'Fabric', 'Mesh'],
        },
        {
            id: 'canvas',
            name: 'Canvas Print',
            description: 'Museum-quality canvas prints for art and photos',
            iconName: 'Palette',
            price: '₹500+',
            popular: false,
            image: 'https://images.unsplash.com/photo-1513519245088-0e12902e35a6?w=400',
            sizes: ['12×18 inch', '18×24 inch', '24×36 inch', 'Custom'],
