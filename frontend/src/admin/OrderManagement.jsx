...
const OrderManagement = ({ orders, isLoading, onRefresh, handleUpdateOrderStatus }) => {
    // Filter states
        ...
        <div className="management-content">
            <div className="management-header">
                ...
                <div className="header-stats">
                    ...
                    {typeof onRefresh === 'function' && (
                        <button type="button" className="header-refresh-btn" onClick={() => onRefresh()} title="Refresh orders">
            ...
            {isLoading ? (
                ...
                <div className="empty-state">
                    ...
                    <p>Try adjusting your search or filters, or refresh to load orders from the server.</p>
                    {typeof onRefresh === 'function' && (
                        <button type="button" className="btn-primary-saas mt-3" onClick={() => onRefresh()}>
