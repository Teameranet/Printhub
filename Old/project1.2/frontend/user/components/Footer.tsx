...
import AdminLoginModal from '../../admin/components/auth/AdminLoginModal';
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/delivery-policy" className="text-gray-600 hover:text-purple-600">Delivery & Return Policy</Link></li>
                <li><Link to="/terms-conditions" className="text-gray-600 hover:text-purple-600">Terms & conditions</Link></li>
              </ul>
